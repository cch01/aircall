...
const Header = ({ currentPath }) => {
  ...
  return (
    <div className="h-12 w-full shadow flex flex-row justify-between items-end bg-gray-200">
      <div className="w-1/3 h-full p-2">
        <div className="w-full h-full bg-center bg-no-repeat bg-contain" style={{ backgroundImage: 'url("assets/dialer.svg")' }} />
      </div>
